<?php
    ...
    function archiveFunction($id){
        ...
        $db->editFindingDocument($attr[0],$attr[1],$attr[2],$attr[3],$attr[9],$attr[8],$attr[10],$attr[4],$attr[5],
                                 $attr[6],$attr[7],$attr[11],$attr[12],$attr[13],true,$attr[15],$attr[16],
    ...
    function restoreFunction($id){
        ...
        $attr = $db->getFindingAttributes($id);
        $db->editFindingDocument($attr[0],$attr[1],$attr[2],$attr[3],$attr[9],$attr[8],$attr[10],$attr[4],$attr[5],
                                 $attr[6],$attr[7],$attr[11],$attr[12],$attr[13],false,$attr[15],$attr[16],
                                 $attr[17],$attr[18],$attr[19], $attr[20],$attr[21],$attr[22],$attr[23],$attr[24],
                                 $attr[25],$attr[26],$attr[27],$attr[28],$attr[29],$attr[30],$attr[31],$attr[32],
                                 $attr[33],$attr[34],$attr[35],$attr[36]);
