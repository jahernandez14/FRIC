...
class table
{
    ...
    private static $tableTypes = array(
        ...
        "Subtask Overview" => array("newLink" => "../views/subtaskContentView.php", "delLink" => "../views/archiveContentView.php", "F" => 1, "C" => 1, "R" => 0, 0 => "Title", 2 => "Task", 3 => "Analyst", 4 => "Progress", 5 => "No. of Findings", 6 => "Due Date"),
    ...
    public function printTable() {
        ...
        if($this->columns["F"] == 1) {
            ...
            echo <<< FILEBUTTONS
            <a class="btn btn-light" href="$createNew?new" role="button" style=color:black>+</a>
            <a class="btn btn-light" href="$archiveSelection" role="button" style=color:black>Archive</a>
            <br></br>
            FILEBUTTONS;
        }
        echo <<< TABLE
